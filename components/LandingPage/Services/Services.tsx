    ...
    >
      <div className="relative mx-auto max-w-5xl text-center ">
        ...
        <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-400">
          ...
          needs. No technical skills required – our team handles all the
      ...
      <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-md border border-neutral-800 bg-neutral-800 p-8 text-center shadow">
          ...
          <h3 className="mt-6 text-indigo-50">ServiceNow Implementation</h3>
          <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-white">
            We provide end-to-end ServiceNow implementation services, from
            planning and design to configuration and deployment.
          </p>
        </div>
        ...
        <div className="rounded-md border border-neutral-800 bg-neutral-800 p-8 text-center shadow">
          ...
          <h3 className="mt-6 text-indigo-50">ServiceNow Consulting</h3>
          <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-white">
            Our ServiceNow consultants can help you optimize your ServiceNow
            platform to align with your business goals.
          </p>
        </div>
        ...
        <div className="rounded-md border border-neutral-800 bg-neutral-800 p-8 text-center shadow">
          ...
          <h3 className="mt-6 text-indigo-50">ServiceNow Support</h3>
          <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-white">
            We offer ongoing ServiceNow support and maintenance services to
